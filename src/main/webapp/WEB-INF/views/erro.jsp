...
<div class="container">
    <div class="card" style="border-left: 6px solid var(--danger);">
        <h2 style="color: var(--danger); margin-bottom: 12px;">⚠ ${erroTitulo} (Código ${erroCodigo})</h2>
        <p style="font-size: 1.1rem; margin-bottom: 20px; color: #334155;">
            ${erroMensagem}
        </p>

        <div style="margin-top: 20px;">
            <a href="javascript:history.back()" class="btn btn-secondary">⬅ Voltar à página anterior</a>
